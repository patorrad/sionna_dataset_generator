...
class Params:
    ...
    def __init__(self, rx_position):
        # algorithm
        self.theta_min = -np.pi #-1.56
        self.theta_max = np.pi #1.56
...
class Algorithm:
    ...
    def __init__(self, params: Params, channel, bandwidth):
        ...
        self.F0 = 2.14e9  # Center frequency in Hz
...
class Capon(Algorithm):
    ...
    def evaluate(self):
        ...
        R = np.cov(self.csi_data) + SMALLEST_NORMAL * np.eye(self.n_rx)
        ...
        return max_angle, self.theta_samples, profile_norm
